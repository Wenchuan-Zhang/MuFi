...
from utils.core_utils import _train_val, _test
...
def main(args):
    ...
    datasets = args.dataset_factory.return_splits(
        ...
        csv_path='/home/zwc/project/MuFi-main/splits/5foldcv/SJ_204.csv',
        fold=None
    )
    ...
    # ckc_metric, train_ckc_metric = _train_val(datasets, i, args, ckc_metric, train_ckc_metric)
        ckc_metric = _test(datasets, i, args, ckc_metric)
        # ckc_metric, train_ckc_metric = _test(datasets, i, args, ckc_metric, train_ckc_metric)
...
if __name__ == "__main__":
    ...
    args.dataset_factory = SurvivalDatasetFactory(
        study=args.study, #shengjinghospital_brca
