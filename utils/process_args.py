...
def _process_args():
    ...
    parser.add_argument('--task', type=str, choices=['survival', 'response'])
    ...
    parser.add_argument('--wsi_folder', type=str, default=None, help='folder containing WSIs')
    
    #----> data related
    # parser.add_argument('--data_root_dir', type=str, default=None, help='data directory')
    parser.add_argument('--data_root_dir_cls256', type=str, default=None, help='data directory')
    parser.add_argument('--data_root_dir_cls4096', type=str, default=None, help='data directory')
    parser.add_argument('--data_root_dir_clsoneslide', type=str, default=None, help='data directory')
    ...
    parser.add_argument('--bag_loss', type=str, choices=['ce_surv', "nll_surv", "nll_rank_surv", "rank_surv", "cox_surv","ce"], default='ce',
